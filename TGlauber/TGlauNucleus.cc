...
void TGlauNucleus::Lookup(const char* name)
{
  ...
  else if (TString(name) == "Ne")      {fN = 20;  fR = 2.396;      fA = 0.592;  fW =  0;       fF = 8;  fZ=10; fBeta2=0.46; fBeta4=0.27;} // WS parameterization
  else if (TString(name) == "Necl")    {fN = 20;  fR = 2.396;      fA = 0.592;  fW =  0;       fF = 6;  fZ=10;} // read configurations from file
