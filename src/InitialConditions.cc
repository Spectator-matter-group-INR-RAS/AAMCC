...
G4bool InitialConditions::SetSysA(G4String SysA_in) {
    ...
    else if(SysA_in == "Oth30"){sourceA = 16; sourceZ = 8; SysA = SysA_in;}
    else if(SysA_in == "Onleft"){sourceA = 16; sourceZ = 8; SysA = SysA_in;}
    ...
    else if(SysA_in == "Nepgcm"){sourceA = 20; sourceZ = 10; SysA = SysA_in;}
    else if(SysA_in == "Nenleft"){sourceA = 20; sourceZ = 10; SysA = SysA_in;}
    ...
    else if(SysA_in == "Sn124"){sourceA = 124; sourceZ = 50; SysA = SysA_in;}
...
G4bool InitialConditions::SetSysB(G4String SysB_in) {
    ...
    else if(SysB_in == "Oth30") {sourceAb = 16; sourceZb = 8; SysB = SysB_in;}
    else if(SysB_in == "Onleft") {sourceAb = 16; sourceZb = 8; SysB = SysB_in;}
    ...
    else if(SysB_in == "Nepgcm"){sourceAb = 20; sourceZb = 10; SysB = SysB_in;}
    else if(SysB_in == "Nenleft"){sourceAb = 20; sourceZb = 10; SysB = SysB_in;}
    ...
    else if(SysB_in == "Sn124"){sourceAb = 124; sourceZb = 50; SysB = SysB_in;}
