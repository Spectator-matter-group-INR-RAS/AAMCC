...
void AAMCCReader::ReadFirstStage(AAMCCrun* runData, InitialConditions* InCond){
  ...
  else
  {
    ...
    while(!NucleusInputLabel){
      std::cout << "Please enter colliding nucleus name (side A). U, U2, Bi, Bipn, Pb, Pbrw, Pbpn, Pbpnrw, Au, Aurw, Au2, Au2rw, Xe, Xe124, Xe130, Ag, Br, Cu, Ca2 (with SRC), Ar, Al, O, O2 (with SRC), Oho (for HO param.), C, He4, He3, H3, d, p is available : ";
    ...
    while(!NucleusInputLabel){
      std::cout << "Please enter colliding nucleus name (side B). U, U2, Bi, Bipn, Pb, Pbrw, Pbpn, Pbpnrw, Au, Aurw, Au2, Au2rw, Xe,  Xe124, Xe130, Ag, Br, Cu, Ca2 (with SRC), Ar, Al, O, O2 (with SRC), Oho (for HO param.), C, He4, He3, H3, d, p is available : ";
